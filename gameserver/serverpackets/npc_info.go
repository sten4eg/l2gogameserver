...
func NeWNpcInfo(client *models.Client) {
	...
	client.Buffer.WriteD(2077)            //_heading //53460
	...
	client.Buffer.WriteD(50)              // _sWimRunSpd
	client.Buffer.WriteD(20)              // _sWimWalkSpd
	client.Buffer.WriteD(0)               // _flyRunSpd
	client.Buffer.WriteD(0)               // _flyWalkSpd
	client.Buffer.WriteD(0)               // _flyRunSpd
	client.Buffer.WriteD(0)               // _flyWalkSpd
	...
	client.Buffer.WriteS("")              //+2           // _name
	client.Buffer.WriteD(-1)              // High Five NPCString ID
	client.Buffer.WriteS("")              //+2            //_title
	...
	client.Buffer.WriteF(10.0) // _collisionRadius
	client.Buffer.WriteF(15.0) // _collisionHeight
	...
	client.SaveAndCryptDataInBufferToSend(true) // 210
}
